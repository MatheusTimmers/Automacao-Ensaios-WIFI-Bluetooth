    ...
    public partial class Principal : Form
    {
        ...
        public void Ensaio_Largura_de_faixa_a_6_dB(string valFreq, string ip, string ensaioAtual)
        {
            ...
            switch (ensaioAtual)
            {
                case "802.11a":
                    ...
                    radical.Largura_6dB(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                    break;
                case "802.11b":
                ...
                case "802.11n (40)":
                    ...
                    radical.Largura_6dB(valFreq, ensaioAtual + valFreq, "40", RefLevel, Att);
                    break;
                case "802.11n (80)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (80), configure o aparelho");
                    radical.Largura_6dB(valFreq, ensaioAtual + valFreq, "80", RefLevel, Att);
                    break;
                case "802.11ac (20)":
                ...
                case "802.11ax (160)":
                    ...
                    radical.Largura_6dB(valFreq, ensaioAtual + valFreq, "160", RefLevel, Att);
                    break;
            }
        }
        ...
        public void Ensaio_Largura_de_faixa_a_26_dB(string valFreq, string ip, string ensaioAtual)
        {
            ...
            switch (ensaioAtual)
            {
                case "802.11a":
                    MessageBox.Show("Iniciando o Ensaio do 802.11a, configure o aparelho");
                    radical.Largura_26dB(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                    break;
                case "802.11b":
                    MessageBox.Show("Iniciando o Ensaio do 802.11b, configure o aparelho");
                    radical.Largura_26dB(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11n (40)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (40), configure o aparelho");
                    radical.Largura_26dB(valFreq, ensaioAtual + valFreq, "40", RefLevel, Att);
                    break;
                case "802.11n (80)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (80), configure o aparelho");
                    radical.Largura_26dB(valFreq, ensaioAtual + valFreq, "80", RefLevel, Att);
                    break;
                case "802.11ac (20)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ac (20), configure o aparelho");
                    radical.Largura_26dB(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11ax (160)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ax (160), configure o aparelho");
                    radical.Largura_26dB(valFreq, ensaioAtual + valFreq, "160", RefLevel, Att);
                    break;
            }
        }
        ...
        public void Ensaio_pico_da_densidade_de_potência(string valFreq, string ip, string ensaioAtual)
        {
            ...
            switch (ensaioAtual)
            {
                case "802.11a":
                    MessageBox.Show("Iniciando o Ensaio do 802.11a, configure o aparelho");
                    radical.Pico_da_densidade_de_potência(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                    break;
                case "802.11b":
                    MessageBox.Show("Iniciando o Ensaio do 802.11b, configure o aparelho");
                    radical.Pico_da_densidade_de_potência(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11n (40)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (40), configure o aparelho");
                    radical.Pico_da_densidade_de_potência(valFreq, ensaioAtual + valFreq, "40", RefLevel, Att);
                    break;
                case "802.11n (80)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (80), configure o aparelho");
                    radical.Pico_da_densidade_de_potência(valFreq, ensaioAtual + valFreq, "80", RefLevel, Att);
                    break;
                case "802.11ac (20)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ac (20), configure o aparelho");
                    radical.Pico_da_densidade_de_potência(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11ax (160)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ax (160), configure o aparelho");
                    radical.Pico_da_densidade_de_potência(valFreq, ensaioAtual + valFreq, "160", RefLevel, Att);
                    break;
            }
        }
        ...
        public void Ensaio_Valor_Medio_Densidade_Espectral(string valFreq, string ip, string ensaioAtual)
        {
            ...
            switch (ensaioAtual)
            {
                case "802.11a":
                    MessageBox.Show("Iniciando o Ensaio do 802.11a, configure o aparelho");
                    radical.Valor_médio_da_densidade_espectral_de_potência(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                    break;
                case "802.11b":
                    MessageBox.Show("Iniciando o Ensaio do 802.11b, configure o aparelho");
                    radical.Valor_médio_da_densidade_espectral_de_potência(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11n (40)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (40), configure o aparelho");
                    radical.Valor_médio_da_densidade_espectral_de_potência(valFreq, ensaioAtual + valFreq, "40", RefLevel, Att);
                    break;
                case "802.11n (80)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (80), configure o aparelho");
                    radical.Valor_médio_da_densidade_espectral_de_potência(valFreq, ensaioAtual + valFreq, "80", RefLevel, Att);
                    break;
                case "802.11ac (20)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ac (20), configure o aparelho");
                    radical.Valor_médio_da_densidade_espectral_de_potência(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11ax (160)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ax (160), configure o aparelho");
                    radical.Valor_médio_da_densidade_espectral_de_potência(valFreq, ensaioAtual + valFreq, "160", RefLevel, Att);
                    break;
            }
        ...
        public void Ensaio_Potencia_de_Pico_Maxima(string valFreq, string ip, string ensaioAtual)
        {
            ...
            switch (ensaioAtual)
            {
                case "802.11a":
                    MessageBox.Show("Iniciando o Ensaio do 802.11a, configure o aparelho");
                    radical.Potência_de_pico_máxima(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                    break;
                case "802.11b":
                    MessageBox.Show("Iniciando o Ensaio do 802.11b, configure o aparelho");
                    radical.Potência_de_pico_máxima(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11n (40)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (40), configure o aparelho");
                    radical.Potência_de_pico_máxima(valFreq, ensaioAtual + valFreq, "40", RefLevel, Att);
                    break;
                case "802.11n (80)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (80), configure o aparelho");
                    radical.Potência_de_pico_máxima(valFreq, ensaioAtual + valFreq, "80", RefLevel, Att);
                    break;
                case "802.11ac (20)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ac (20), configure o aparelho");
                    radical.Potência_de_pico_máxima(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11ax (160)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ax (160), configure o aparelho");
                    radical.Potência_de_pico_máxima(valFreq, ensaioAtual + valFreq, "160", RefLevel, Att);
                    break;
            }
        }
        ...
        public void Ensaio_Valor_médio_da_potência_máxima_de_saída(string valFreq, string ip, string ensaioAtual)
        {
            ...
            switch (ensaioAtual)
            {
                case "802.11a":
                    MessageBox.Show("Iniciando o Ensaio do 802.11a, configure o aparelho");
                    radical.Valor_médio_da_potência_máxima_de_saída(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                    break;
                case "802.11b":
                    MessageBox.Show("Iniciando o Ensaio do 802.11b, configure o aparelho");
                    radical.Valor_médio_da_potência_máxima_de_saída(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11n (40)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (40), configure o aparelho");
                    radical.Valor_médio_da_potência_máxima_de_saída(valFreq, ensaioAtual + valFreq, "40", RefLevel, Att);
                    break;
                case "802.11n (80)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11n (80), configure o aparelho");
                    radical.Valor_médio_da_potência_máxima_de_saída(valFreq, ensaioAtual + valFreq, "80", RefLevel, Att);
                    break;
                case "802.11ac (20)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ac (20), configure o aparelho");
                    radical.Valor_médio_da_potência_máxima_de_saída(valFreq, ensaioAtual + valFreq, "20", RefLevel, Att);
                ...
                case "802.11ax (160)":
                    MessageBox.Show("Iniciando o Ensaio do 802.11ax (160), configure o aparelho");
                    radical.Valor_médio_da_potência_máxima_de_saída(valFreq, ensaioAtual + valFreq, "160", RefLevel, Att);
                    break;
            }
